...
tools(){
    ...
    mygit="https://github.com/Antboy889/"
...
password(){
    ...
    echo -e $green"{";
    echo -e $yellow" Coder : Antboy,";
    echo -e $yellow" FB : ace.of.spades.729,";
    echo -e $yellow" IG : Antboy,";
    echo -e $green"}\n";

    echo -e $blue"{ Login Dulu Bro }";
    echo -e $yellow"Note : Kalo gk tau username & password nya chat gw 088977160001";
